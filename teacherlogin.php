...
<div class="subheading"><p>Teacher Login</p></div>
</center>
...
$sql="SELECT * FROM $tbl_name WHERE teacher_id='$teacher_id' and password='$password'";
...
$tbl_name1="teachers";
$sql1="SELECT * FROM $tbl_name1 WHERE teacher_id='$teacher_id'";
$result1=mysql_query($sql1);
$rows1=mysql_fetch_array($result1);
$name=$rows1['name'];

$thisdir = getcwd(); 
mkdir($thisdir."\\filemanager\Teachers\\".$teacher_id , 0777); 
mkdir($thisdir."\\filemanager\Teachers\\".$teacher_id."\\assignmentuploads" , 0777); 
 $diroo=$thisdir."\\filemanager\Teachers\\".$teacher_id;
