...
$sql1="SELECT * FROM $tbl_name1 where resource_type='image' ORDER BY resource_id DESC";
...
<div class="subheading"><p>Image Gallery</p></div>
<ul class="slideshow">
<li><img width="600" height="400" src="saevjti.jpg" /></li>
         <li><img width="600" height="400" src="ecelllogo.jpg" /></li>
      </ul>   
</div>
