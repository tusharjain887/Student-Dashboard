...
$sql = "SELECT * FROM $tbl_name WHERE user_id='$user_id' ORDER BY event_id DESC";
...
<br>
<div class="subheading"><p>My Events</p></div>
<div class="lform">
<?php
...
?>
<p><a href="view_event.php?event_id=<? echo $rows['event_id']; ?>&hash=<? echo $hash ?>"><? echo $rows['event_topic']; ?></a></p><br>
<b>Posted by <? echo $rows['user_name']; ?></b><br>
...
?>
<br>
<a href="create_event.php"><strong>Create New Event</strong> </a>
</div></div>
