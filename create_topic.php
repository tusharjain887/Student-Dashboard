...
<br>
<div class="subheading"><p>Create Topic</p></div>
<div class="lform">
<table width="600" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
<tr>
<form id="form1" name="form1" method="post" action="add_topic.php" onsubmit="return validateForm()">
<td>
...
<td width="2%">:</td>
<td width="84%"><br><br><textarea name="topic" cols="50" rows="3" id="topic"></textarea><br><br></td>
</tr>
<tr>
<td valign="top"><strong>Detail</strong></td>
<td valign="top">:</td>
<td><textarea name="detail" cols="50" rows="7" id="detail"></textarea><br><br></td>
</tr>
<tr>
<td valign="top">&nbsp</td>
<td valign="top">&nbsp</td>
<td><input type="hidden" name="hash" value="<? echo $hash1 ?>" /></td>
</tr>
<tr>
<td><input name="category_id" type="hidden" value="<? echo $category_id; ?>" /></td>
<td><input name="category_name" type="hidden" value="<? echo $category_name; ?>" /></td>
