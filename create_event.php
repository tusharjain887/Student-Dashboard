...
<br>
<div class="subheading"><p>Create New Event</p></div>
<div class="lform">
<form id="form1" name="form1" method="post" action="add_event.php" onsubmit="return validateForm()">
<br><br><br>
<b>Topic          :      <input name="topic" type="text" id="topic" size="50" /><br><br>
<b>Description       :      <br><textarea name="detail" cols="60" rows="5" id="detail"></textarea><br><br>
...
Select Class       :
<select name="level">
<option value="9">B.Tech
<option value="10">T.Y.B.Tech
<option value="11">S.Y.B.Tech
<option value="12">F.Y.B.Tech
</select>
<?php
}
?>
<br><br><center><input type="submit" name="Submit" value="Submit" /> <input type="reset" name="Submit2" value="Reset" /></center><br>
</form>
</div>
</div>	 
