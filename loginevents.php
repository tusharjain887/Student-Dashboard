...
$query = "SELECT COUNT(*) as num FROM $tbl_name WHERE class_id LIKE '%$class_id%'";
$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages['num'];

	
	/* Setup vars for query. */
	$targetpage = "loginevents.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name WHERE class_id LIKE '%$class_id%' ORDER BY event_id DESC LIMIT $start, $limit";
...
?>
<center><a href="view_event.php?event_id=<? echo $event_id ?>&hash=<? echo $hash ?>"><? echo $rows['event_topic']; ?></a></center><br>
<b>Posted by <? echo $rows['user_name']; ?></b>
<br><hr>
<?php
