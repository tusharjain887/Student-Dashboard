...
$sql="SELECT * FROM $tbl_name WHERE student_id =$user_id";
...
$sql1="SELECT * FROM $tbl_name1 WHERE student_id =$user_id";
...
<td width="45">:</td>
<td width="205"><input name="student_id" type="text" id="student_id" size="30" value="<? echo $rows['student_id']; ?>" readonly></td>
</tr>
<tr>
